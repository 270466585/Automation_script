...
class MoKuai(unittest.TestCase):
    ...
    def test_CDGL4(self):
        ...
        # name=self.MK.assertion_test9()
        # if name==read_Data.getExcel2(2,6):
        #     self.MK.assertion_test10()
        # else:
        #     self.MK.assertion_test4(read_Data.getExcel2(2,6),read_Data.getExcel2(8,5))
        #     self.MK.assertion_test10()
        data3 = self.MK.assertion_test3()
        try:
            data31 = int(data3[11])
            ...
            self.assertEqual(Data3, data2)
        #self.MK.assertion_test4(read_Data.getExcel2(2, 6), read_Data.getExcel2(8, 5))
        #self.MK.assertion_test11(read_Data.getExcel2(2, 6), read_Data.getExcel2(8, 5))
